    ...
    <footer className="border-t border-border bg-background-inverse text-text-inverse">
      <div className="qh-container qh-footer-grid grid gap-8 py-12">
        <div>
          ...
          <p className="mt-4 text-base leading-relaxed opacity-70">Warm, premium, playful decor for Indian homes that refuse to be boring.</p>
          <div className="mt-6 flex items-center gap-3">
            <Link href="#" aria-label="Instagram" className="qh-focus inline-flex h-10 w-10 items-center justify-center rounded-full border border-border text-text-inverse transition-colors duration-fast hover:border-[#a78bfa] hover:text-[#a78bfa]">
              <SocialIcon>
            ...
            <Link href="#" aria-label="Pinterest" className="qh-focus inline-flex h-10 w-10 items-center justify-center rounded-full border border-border text-text-inverse transition-colors duration-fast hover:border-[#a78bfa] hover:text-[#a78bfa]">
              <SocialIcon>
            ...
            <Link href="#" aria-label="YouTube" className="qh-focus inline-flex h-10 w-10 items-center justify-center rounded-full border border-border text-text-inverse transition-colors duration-fast hover:border-[#a78bfa] hover:text-[#a78bfa]">
              <SocialIcon>
            ...
            <Link href="#" aria-label="Facebook" className="qh-focus inline-flex h-10 w-10 items-center justify-center rounded-full border border-border text-text-inverse transition-colors duration-fast hover:border-[#a78bfa] hover:text-[#a78bfa]">
              <SocialIcon>
            ...
            <Link href="#" aria-label="LinkedIn" className="qh-focus inline-flex h-10 w-10 items-center justify-center rounded-full border border-border text-text-inverse transition-colors duration-fast hover:border-[#a78bfa] hover:text-[#a78bfa]">
              <SocialIcon>
          ...
          <p className="mt-4 text-base font-bold text-white">Talk to us</p>
          <p className="mt-2 text-base opacity-70">+91 7678099909</p>
        </div>
        
        {/* Quick Links Column */}
        <div>
          <h3 className="text-lg font-bold text-white">Quick Links</h3>
          <div className="mt-4 grid gap-2 text-base opacity-75">
            {quickLinks.map((link) => (
              <Link key={link.label} href={link.href} className="transition-colors duration-fast hover:text-[#a78bfa]">
                {link.label}
              </Link>
            ))}
          </div>
        ...
        <div>
          ...
          <div className="mt-4 grid gap-2 text-base opacity-75">
            {shopCategories.map((category) => (
              <Link key={category.slug} href={`/${category.slug}`} className="transition-colors duration-fast hover:text-[#a78bfa]">
                {category.name}
              </Link>
            ))}
          </div>
